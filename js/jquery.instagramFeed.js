		...
		$.ajax({
			...
			success: function(data){
				...
				if(options.display_profile){
					...
					html += "	<p class='instagram_username'"+ styles.profile_name +"><a target='_blank' class='maroon' href='https://www.instagram.com/"+ options.username +"'>@"+options.username+"</a></p>";
				}
